...
This repository contains the conceptual definition and theoretical framework for **Community Resources**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── community-resources.tex    # LaTeX dissertation
├── whitepaper/
│   └── community-resources.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025communityresources,
  author = {Vega, Adam Eren},
  title = {Community Resources: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/community-resources}
}
```
